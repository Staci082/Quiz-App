            ...
            <section className="flex flex-col items-center py-8">
                ...
                {showBottomElement && (
                    <div className="fixed bottom-0 p-10 pt-5 bg-gradient-to-bl from-teal-400 to-teal-600 border-teal-700 flex flex-col items-center gap-5 rounded-t-3xl lg:max-w-[35%] md:max-w-[50%] w-full">
                        ...
                        <a href="/questions" className="bg-white active:translate-y-1 text-gray-400 py-2 mt-2 rounded-xl max-w-[500px] border-b-4 border-l-2 border-gray-400  min-w-[300px]">Play</a>
                    </div>
                )}
            </section>
        </>
